...
3. **Utility features: 35 → 30 (0).** MET target. **T125 shipped end-to-end 2026-07-20** — the flagship "make Jenn talk about the app" hook. Aging reminders + shelf-state tracking + community insights + cron + settings + slime detail integration all live. Well past IG target. V2 (aging history graph, extended-life leaderboard) rolls to post-launch.
