  ...
  return (
    <div
      style={{
        ...
        zIndex: 100,
        background: "#0A0A0A",
        // [Bug 4] Use flex column so sticky footer pins to bottom of viewport
        display: "flex",
    ...
    >
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* [Bug 1] Show live count instead of static prop */}
                {liveCommentCount > 0 && (
                  <span
                    style={{
                      fontSize: 12,
            ...
            {/* Comment section */}
            {/* [Bug 1] Pass onCountChange so comment count stays live */}
            <div ref={commentRef} style={{ paddingBottom: 16 }}>
              <CommentSection
                logId={log.id}
                currentUserId={currentUserId}
      ...
      {/* [Bug 4] View Full Review — sticky footer, always visible at bottom of overlay */}
      <div
        style={{
          flexShrink: 0,
          position: "sticky",
