      ...
      <header className="px-4 pt-10 pb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/*
             * Edit hint — only shown for auto-generated usernames.
             * Rendered as a button stub so it can easily be wired to a
             * settings/edit-profile route later. No action yet.
             */}
            {isAutoGenerated && (
