...
/**
 * Returns display-friendly name info from a raw username.
 *
 * - Auto-generated usernames (starting with "user_") → displayName = "Slimer",
 *   handle = the raw username, isAutoGenerated = true so we can show the edit hint.
 * - Customized usernames → displayName = username, handle = null, isAutoGenerated = false.
 */
      ...
      <header className="px-4 pt-10 pb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Handle: always shown — raw username if auto-generated, else @username */}
            <p className="text-sm text-gray-400 mt-0.5 truncate">
              @{handle ?? rawUsername}
            </p>

            {/*
             * Edit hint — links to /settings/profile.
             * Shown for auto-generated usernames; replaced with a subtler
             * settings link for customized usernames.
             */}
            {isAutoGenerated ? (
              <Link
