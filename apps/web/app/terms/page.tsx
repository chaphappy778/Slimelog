export default function TermsPage() {
  return (
    ...
    >
      ...
      <h2 style={{ color: "#00F0FF", marginTop: "1.5rem" }}>Acceptable Use</h2>
      <p style={{ color: "rgba(245,245,245,0.7)", lineHeight: 1.7 }}>
      ...
      <p style={{ color: "rgba(245,245,245,0.7)", lineHeight: 1.7 }}>
        $4.99 per month, billed monthly, cancel anytime. No refunds for partial
        months.
      </p>
      ...
      <p style={{ color: "rgba(245,245,245,0.7)", lineHeight: 1.7 }}>
        The app is provided as-is. We are not liable for user-generated content.
      </p>
      ...
      <p style={{ marginTop: "2rem" }}>
        <a href="/privacy" style={{ color: "#00F0FF" }}>
